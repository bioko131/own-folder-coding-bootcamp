...
;ea();function Ta(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){Ua(b)}}:a}
function Ua(a){var b=w("yt.logging.errors.log");b?b(a,void 0,void 0,void 0,void 0):(b=T("ERRORS",[]),b.push([a,void 0,void 0,void 0,void 0]),Sa("ERRORS",b))}
...
;function Ya(a,b){A(a)&&(a=Ta(a));return window.setTimeout(a,b)}
...
function cb(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=a.match(Q)[1]||null,e=R(a.match(Q)[3]||null);d&&e?(d=c,c=a.match(Q),d=d.match(Q),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?R(c.match(Q)[3]||null)==e&&(Number(c.match(Q)[4]||null)||null)==(Number(a.match(Q)[4]||null)||null):!0;for(var f in ab){if((e=d=T(ab[f]))&&!(e=c)){e=f;var g=T("CORS_HEADER_WHITELIST")||{},k=R(a.match(Q)[3]||null);e=k?(g=g[k])?0<=ha(g,e):!1:!0}e&&(b[f]=d)}return b}
function db(a,b){var c=T("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.G&&(!R(a.match(Q)[3]||null)||b.withCredentials||R(a.match(Q)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.o&&b.o[c])}
function eb(a,b){var c=b.format||"JSON";b.H&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=T("XSRF_FIELD_NAME",void 0),e=T("XSRF_TOKEN",void 0),f=b.J;f&&(f[d]&&delete f[d],a=$a(a,f||{}));f=b.I||"";var g=b.o;db(a,b)&&(g||(g={}),g[d]=e);g&&u(f)&&(d=Za(f),sa(d,g),f=b.B&&"JSON"==b.B?JSON.stringify(d):Ra(d));d=f||g&&!oa(g);!bb&&d&&"POST"!=b.method&&(bb=!0,Ua(Error("AJAX request with postData should use POST")));var k=!1,h,
q=fb(a,function(a){if(!k){k=!0;h&&window.clearTimeout(h);var d=Xa(a),e=null;if(d||400<=a.status&&500>a.status)e=gb(c,a,b.F);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}e=e||{};var f=b.context||t;d?b.l&&b.l.call(f,a):b.onError&&b.onError.call(f,a,e);b.A&&b.A.call(f,a,e)}},b.method,f,b.headers,b.responseType,b.withCredentials);
...
return b}
function fb(a,b,c,d,e,f,g){function k(){4==(h&&"readyState"in h?h.readyState:0)&&b&&Ta(b)(h)}
...
;function kb(){var a=lb()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=pa();return new M(function(c,d){b.l=function(a){Xa(a)?c(a):d(new U("Request failed, status="+a.status,"net.badstatus"))};
b.onError=function(){d(new U("Unknown request error","net.unknown"))};
b.m=function(){d(new U("Request timed out","net.timeout"))};
eb(a,b)})}
function U(a,b){D.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
r(U,D);function V(a){this.c=void 0===a?null:a;this.a=0;this.b=null}
V.prototype.then=function(a,b,c){return this.c?this.c.then(a,b,c):1===this.a&&a?(a=a.call(c,this.b),L(a)?a:mb(a)):2===this.a&&b?(a=b.call(c,this.b),L(a)?a:nb(a)):this};
Ba(V);function nb(a){var b=new V;a=void 0===a?null:a;b.a=2;b.b=void 0===a?null:a;return b}
function mb(a){var b=new V;a=void 0===a?null:a;b.a=1;b.b=void 0===a?null:a;return b}
;function W(a){D.call(this,a.message||a.description||a.name);this.isMissing=a instanceof X;this.isTimeout=a instanceof U&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof P}
r(W,D);W.prototype.name="BiscottiError";function X(){D.call(this,"Biscotti ID is missing from server")}
r(X,D);X.prototype.name="BiscottiMissingError";var qa={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Y=null;function ob(){if("1"===na(T("PLAYER_CONFIG",{}),"args","privembed"))return Fa(Error("Biscotti ID is not available in private embed mode"));Y||(Y=O(kb().then(pb),function(a){return qb(2,a)}));
return Y}
function lb(){var a;(a=!!na(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie"))||(a=!!T("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1));a||(a=!!T("EXPERIMENT_FLAGS",{}).html5_serverside_pagead_id_sets_cookie);return a}
function pb(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new X;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new X;a=a.id;rb(a);Y=mb(a);sb(18E5,2);return a}
function qb(a,b){var c=new W(b);rb("");Y=nb(c);0<a&&sb(12E4,a-1);throw c;}
function sb(a,b){Ya(function(){O(kb().then(pb,function(a){return qb(b,a)}),x)},a)}
function rb(a){v("yt.ads.biscotti.lastId_",a)}
;w("yt.ads.biscotti.getId_")||v("yt.ads.biscotti.getId_",ob);var Z;try{var tb=w("yt.ads.biscotti.getId_");Z=tb?tb():ob()}catch(a){Z=Fa(a)}O(Z,x);}).call(this);
