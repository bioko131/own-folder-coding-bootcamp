...
Panopto.ModalPopup.prototype =
{
    ...
    reloadFrame: true, // Whether or not to reload the outer frame (e.g. when switching page sets)

    windowNavigationMessage: null, // Confirmation message to be set by inner frame
    ...
    updateFrame: function () 
    {
        ...
        $("#modalLink-" + this._page).addClass("selected");
    ...
    show: function (page, selectedItemName, queryParams)
    {
        ...
        // Remove tabindex from elements on outer page
        $("#wrapper *").each(function ()
        {
            if ($(this).attr("tabindex") === 0)
            {
                $(this).attr("tabindex", -1);
                $(this).toggleClass("outer-focusable", true);
            }
        });
    ...
    hide: function (handler, clear)
    {
        ...
        else
        {
            ...
            // Replace tabindices on outer page
            $("#wrapper .outer-focusable").each(function ()
            {
                if ($(this).attr("tabindex") === -1)
                {
                    $(this).attr("tabindex", 0);
                    $(this).toggleClass("outer-focusable", false);
                }
            });
...
Panopto.ModalPopup.pageSets =
{
    ...
    GroupLinks:
    {
        ...
        [
            ...
            { Name: "GroupMembership", URL: "Membership.aspx" },
