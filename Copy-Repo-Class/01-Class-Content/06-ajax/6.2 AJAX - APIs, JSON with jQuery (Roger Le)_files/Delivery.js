...
Panopto.API.Delivery = (function () {
    ...
    var ajaxCall = function (uri, params, onSuccess, onFailure) {
        ...
        $.ajax({
            url: "{0}://{1}{2}/Pages/Viewer/{3}".format(Panopto.uriScheme, Panopto.webServerFQDN, Panopto.appRoot, uri), // absolute url
            type: "POST",
            data: params,
            dataType: "json",
            success: onSuccess,
    ...
    return {
        ...
        getCaptions: function (deliveryId, inviteTokenId, onSuccess, onFailure) {
            ajaxCall("DeliveryInfo.aspx", { deliveryId: deliveryId, tid: inviteTokenId, getCaptions: true },
                function (data) {
                    // sometimes data has an ErrorCode, so check for that here
                    if (!data.ErrorCode) {
                        onSuccess(data);
        ...
        rateDelivery: function (deliveryId, rating, onSuccess, onFailure) {
            ajaxCall("RateDelivery.aspx", { deliveryID: deliveryId, rating: rating },
                function (data) {
        ...
        deleteEvent: function (sessionId, eventType, eventId, onSuccess, onFailure) {
            ajaxCall("Notes/Note_Delete.aspx", { sessionid: sessionId, type: eventType, eventid: eventId },
                function (data) {
