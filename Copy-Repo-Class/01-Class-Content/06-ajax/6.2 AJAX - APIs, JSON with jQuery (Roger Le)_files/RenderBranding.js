...
/// <reference path="~/Scripts/jquery_rule/jquery.rule.js" />
...
Panopto.Branding.renderBrandingColors = function (color) {
    ...
    if (Panopto.branding.isAccentColorDefault) {
    ...
    var createGradientButton = function(selector, top, bottom, upperBorder, borderSides, lowerBorder) {
        return {
            ...
            "background-image: -ms-linear-gradient(90deg, {0} 0%, {1} 100%)".format(bottom, top), // ie10+
            "-ms-filter: \"progid:DXImageTransform.Microsoft.gradient(startColorStr='{0}',EndColorStr='{1}')\"".format(top, bottom), // ie
